                        ...
                        <div class="row center-block">
                            <div class="col-sm-offset-0 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="goodname" class="form-control" id="goodname" value="<%=rs.getString("gname")%>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="totalprice" class="form-control" id="totalprice" value="<%=tprice%>">
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <script>
            function subform(){
                $.post($("#form1").attr("action"), $("#form1").serialize(),function(data){
                    if(data == 1){
                        alert("变更成功!");
                        window.location.href = "./profile_order_all.jsp";
                    }
                });
            }
        </script>
