                    ...
                    <div class="row page-header">
                        <div class="col-md-12">
                            <ul class="nav nav-tabs">
                                ...
                                <li role="presentation" class="active"><a href="#">派送中的订单</a></li>
                                <li role="presentation"><a href="order_done.jsp">已经完成的订单</a></li>
                            </ul>
                        </div>
                            ...
                            <div class="col-sm-offset-0 col-sm-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = MC.getRs("select * from orders o left join goods g on o.gid=g.gid where o.ostat=\"2\" and o.disid=\""+username+"\" order by o.id desc;");
                                        while(rs.next()){
                                            String stats = null;
