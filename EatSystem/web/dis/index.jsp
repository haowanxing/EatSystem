                    ...
                    <div class="row page-header">
                        <div class="col-md-12">
                            <ul class="nav nav-tabs">
                                <li role="presentation" class="active"><a href="#">等待派送的订单</a></li>
                            ...
                            <div class="col-sm-offset-0 col-sm-12">
                                <table class="table table-striped table-bordered">
                                    ...
                                    <%
                                        ...
                                        ResultSet rs = MC.getRs("select * from orders o left join goods g on o.gid=g.gid where o.ostat=\"1\" order by o.id desc;");
                                        while(rs.next()){
                                            String stats = null;
