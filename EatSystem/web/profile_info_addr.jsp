            ...
            <div class="row">
                <div class="col-md-2  col-xs-10">
                    <div class="list-group">
                        ...
                        <a class="list-group-item btn btn-default active" href="profile_info_addr.jsp">地址管理</a>
                        <a class="list-group-item btn btn-default" href="profile_info_pwd.jsp">修改密码</a>
                    </div>
                </div>
                <div class="col-md-10  col-xs-12">
                    <div class="panel panel-info">
                        <div class="panel-heading">我的地址</div>
                        <div class="panel-body">
                            <form id="form1" action="User" method="post">
                                <input type="hidden" name="act" value="chaddr"/>
                                <div class="row col-md-offset-1 form-group">
                                    <label for="addr" class="col-md-2 col-xs-4 control-label">收货地址：</label>
                                    <div class="col-md-3 col-xs-6">
                                        <input class="form-control" type="text" id="addr" name="useraddr" value="<%=session.getAttribute("useraddr")%>" />
                                    </div>
                                </div>
                                <div class="row col-md-offset-1 form-group">
        ...
        <script>
            function subform(){
                $.post($("#form1").attr("action"), $("#form1").serialize(),function(data){
                    if(data == 1){
                        alert("提交成功!");
                        window.location.href = "./profile_info_addr.jsp";
                    }else{
